...
//call .Pkg() with the folder raylib-zig is in relative to project build.zig
...
pub fn build(b: *Builder) void {
    ...
    const exe = b.addExecutable("egocells-markdown", "src/main.zig");
    ...
    const run_step = b.step("run", "run egocells-markdown");
