...
__kernel void markdown(__read_only image3d_t in_img, __write_only image3d_t out_img) {
    ...
    // uint4 leftL3 = get_layer_value(in_img, left, 4);
    // uint4 leftL4 = get_layer_value(in_img, left, 5);
    // uint4 leftL5 = get_layer_value(in_img, left, 6);

    uint4 rightL1 = get_layer_value(in_img, right, 1);
    uint4 rightL2 = get_layer_value(in_img, right, 2);
    // uint4 rightL3 = get_layer_value(in_img, right, 4);
    // uint4 rightL4 = get_layer_value(in_img, right, 5);
    // uint4 rightL5 = get_layer_value(in_img, right, 6);

    uint4 topL1 = get_layer_value(in_img, top, 1);
    uint4 topL2 = get_layer_value(in_img, top, 2);
    // uint4 topL3 = get_layer_value(in_img, top, 4);
    // uint4 topL4 = get_layer_value(in_img, top, 5);
    // uint4 topL5 = get_layer_value(in_img, top, 6);

    uint4 bottomL1 = get_layer_value(in_img, bottom, 1);
    uint4 bottomL2 = get_layer_value(in_img, bottom, 2);
    // uint4 bottomL3 = get_layer_value(in_img, bottom, 4);
    // uint4 bottomL4 = get_layer_value(in_img, bottom, 5);
    // uint4 bottomL5 = get_layer_value(in_img, bottom, 6);
